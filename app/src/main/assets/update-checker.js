(function () {
  const VERSION = window.AmyFXAppVersion || { name: '2.0.0-pro.348', code: 950348 };
  const CURRENT_VERSION_CODE = Number(VERSION.code) || 950348;
  const CURRENT_VERSION_NAME = String(VERSION.name || '2.0.0-pro.348');
