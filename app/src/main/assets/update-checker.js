(function () {
  const VERSION = window.AmyFXAppVersion || { name: '2.0.0-pro.364', code: 950364 };
  const CURRENT_VERSION_CODE = Number(VERSION.code) || 950364;
  const CURRENT_VERSION_NAME = String(VERSION.name || '2.0.0-pro.364');
