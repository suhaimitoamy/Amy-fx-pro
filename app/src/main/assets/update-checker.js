(function () {
  const VERSION = window.AmyFXAppVersion || { name: '2.0.0-pro.360', code: 950360 };
  const CURRENT_VERSION_CODE = Number(VERSION.code) || 950360;
  const CURRENT_VERSION_NAME = String(VERSION.name || '2.0.0-pro.360');
