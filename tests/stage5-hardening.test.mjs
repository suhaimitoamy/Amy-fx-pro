...
test('published Pro metadata is never ahead of the Pro APK source version', () => {
  ...
  assert.match(metadata.apk_url || metadata.downloadUrl || '', /amyfx-pro-2\.0\.0-pro\.317\/AmyFX-Pro-latest\.apk/);
...
test('active Pro release workflow pins signing continuity and verifies the built APK', () => {
  ...
  assert.match(workflow, /AMYFX_VERSION_NAME: "2\.0\.0-pro\.317"/);
  assert.match(workflow, /AMYFX_VERSION_CODE: "950317"/);
